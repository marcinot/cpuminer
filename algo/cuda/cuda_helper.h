...
__device__ __forceinline__ void gpu_utils_print_mem(const void* memory, uint32_t n)
{
...
__device__ __forceinline__ void gpu_utils_print_words(const uint32_t* memory, uint32_t n)
{	
	for(uint32_t i=0; i<n; i++)
	{		
